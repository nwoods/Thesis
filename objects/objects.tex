...
The total efficiency of all selections is estimated by finding the fraction of events in the {\POWHEG} and {\MCFM} {\ZZ} samples which pass both the fiducial cuts at generator level and the full analysis selection after detector simulation and reconstruction.
